...
namespace Skoruba.IdentityServer4.STS.Identity
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthenticationServices<ConfigurationDbContext, PersistedGrantDbContext, IdentityDbContext, IdentityUser, IdentityRole>(Environment, Configuration, Logger);
