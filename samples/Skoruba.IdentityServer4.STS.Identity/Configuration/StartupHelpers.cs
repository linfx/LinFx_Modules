...
namespace Skoruba.IdentityServer4.STS.Identity.Helpers
{
    public static class StartupHelpers
    {
        ...
        public static void AddAuthenticationServices<TConfigurationDbContext, TPersistedGrantDbContext, TIdentityDbContext, TIdentityUser, TIdentityRole>(this IServiceCollection services, IWebHostEnvironment hostingEnvironment, IConfiguration configuration, ILogger logger)
            ...
            where TIdentityRole : class
        {
            ...
            AddIdentityServer<TConfigurationDbContext, TPersistedGrantDbContext, TIdentityUser>(services, configuration, logger, hostingEnvironment);
        }
