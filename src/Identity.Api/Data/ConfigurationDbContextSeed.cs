    ...
    public class ConfigurationDbContextSeed
    {
        public async Task SeedAsync(ConfigurationDbContext context,IConfiguration configuration)
        {
            ...
            var clientUrls = new Dictionary<string, string>
            {
                ...
                { "ParkWebClient", configuration.GetValue<string>("MvcClient") },
            ...
            {
                foreach (var client in Clients.GetClients(clientUrls))
                {
            ...
            {
                foreach (var resource in Clients.GetIdentityResources())
                {
            ...
            {
                foreach (var api in Clients.GetApiResources())
                {
